...
{var el=jQuery('.cli-privacy-content .cli-privacy-content-text');if(el.length>0){clone=el.clone(),originalHtml=clone.html(),originalHeight=el.outerHeight(),Trunc={addReadmore:function(textBlock)
